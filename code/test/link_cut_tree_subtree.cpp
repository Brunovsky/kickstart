...
int main() {
    ...
    RUN_SHORT(speed_test_lct_subtree(25000, lct_speed_query_heavy_actions));
    RUN_SHORT(speed_test_lct_subtree(25000, lct_speed_update_heavy_actions));
    RUN_SHORT(speed_test_lct_subtree(25000, lct_speed_topo_heavy_actions));
    return 0;
}
