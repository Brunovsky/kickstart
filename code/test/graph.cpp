...
void test_random_regular_performance(int M = 1) {
    random_regular_performance(M * 100, 300, 100);
    random_regular_performance(M * 100, 300, 150);
    random_regular_performance(M * 100, 300, 200);
    random_regular_performance(M * 50000, 25, 4);
    random_regular_performance(M * 50000, 25, 6);
    random_regular_performance(M * 50000, 25, 8);
    random_regular_performance(M * 50000, 25, 10);
    random_regular_performance(M * 30000, 36, 5);
    random_regular_performance(M * 30000, 36, 6);
    random_regular_performance(M * 30000, 36, 7);
    random_regular_performance(M * 30000, 36, 8);
    random_regular_performance(M * 30000, 36, 9);
    random_regular_performance(M * 30000, 36, 10);
    random_regular_performance(M * 10000, 80, 5);
    random_regular_performance(M * 10000, 80, 7);
    random_regular_performance(M * 10000, 80, 9);
    random_regular_performance(M * 10000, 80, 11);
    random_regular_performance(M * 10000, 80, 13);
    random_regular_performance(M * 10000, 80, 15);
    random_regular_performance(M * 1000, 400, 10);
    random_regular_performance(M * 1000, 400, 12);
    random_regular_performance(M * 1000, 400, 14);
    random_regular_performance(M * 1000, 400, 16);
    random_regular_performance(M * 1000, 400, 18);
    random_regular_performance(M * 1000, 400, 20);
    random_regular_performance(M * 60, 10000, 30);
    random_regular_performance(M * 60, 10000, 35);
    random_regular_performance(M * 60, 10000, 40);
    random_regular_performance(M * 60, 10000, 45);
    random_regular_performance(M * 60, 10000, 50);
    random_regular_performance(M * 10, 50000, 30);
    random_regular_performance(M * 10, 50000, 60);
    random_regular_performance(M * 10, 50000, 90);
    random_regular_performance(M * 10, 50000, 120);
}
