...
using dft_subtree = depth_first_tree<dft_node_sum>;
...
void unit_test_dft() {
    ...
    auto test_in_subtree = [&](int u, int v) {
        print("is_descendant({},{}): {}\n", u, v, dft.is_descendant(u, v));
    };
    auto test_subtree = [&](int u) {
        print("subtree({}): {}\n", u, dft.access_subtree(u)->subtree());
    };
    auto test_subt_size = [&](int u) {
        print("subt_size({}): {}\n", u, dft.access_subtree(u)->subtree_size());
    };
    dft.link(1, 2);
    dft.link(2, 3);
    dft.link(4, 7);
    ...
    test_in_subtree(7, 6);
    test_in_subtree(6, 3);
    dft.access_node(3)->self = 70;
    dft.access_node(8)->self = 30;
    dft.access_node(7)->self = 20;
    dft.access_node(2)->self = 10;
    dft.access_subtree(6)->lazy += 50;
    test_subt_size(6);
    test_subt_size(3);
    test_subtree(3);
    test_subtree(6);
