...
using ordered_set =
    gnu::tree<T, null_type, CompareFn, rb_tree_tag, tree_order_statistics_node_update>;

template <typename Key, typename Value, typename CompareFn = less<Key>>
using ordered_map =
    gnu::tree<Key, Value, CompareFn, rb_tree_tag, tree_order_statistics_node_update>;
